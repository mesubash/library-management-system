package com.projects.librarymanagement.model;
...
public class User {
    ...
    public User(Long id, String identifier,String username, String password, String email, String firstName, String lastName,
